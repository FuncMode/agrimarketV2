...
class IssueModal {
  ...
  render() {
    ...
    const footerHTML = `
      ...
      <button type="button" id="submit-issue-btn" class="btn btn-primary" onclick="document.getElementById('issue-form').requestSubmit()">
  ...
  attachEventListeners() {
    ...
    // Evidence input might not be present if the file input ID changed, checking... 
    // it was id="issue-evidence" in render()
    ...
    // Close handlers
    // Note: Modal component handles the close button and backdrop click
    if (cancelBtn) {
    ...
    if (descriptionTextarea) {
      descriptionTextarea.addEventListener('input', (e) => {
        ...
        const counterEl = document.getElementById('description-count');
