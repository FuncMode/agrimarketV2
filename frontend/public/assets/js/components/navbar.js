  ...
  navbar.innerHTML = `
    <div class="navbar-container">
      ...
      <a href="/index.html" class="navbar-brand">
        <img src="/assets/images/logo.png" alt="AgriMarket" class="h-10 w-auto" style="filter: brightness(0) saturate(100%) invert(45%) sepia(71%) saturate(348%) hue-rotate(89deg) brightness(102%) contrast(103%);">
        AgriMarket
      </a>
